...
<html>
  ...
  <body>
  	...
  	<div style="width:100%;height:2200px;background:rgb(195,195,195)">
  		<div style="width:1200px;height:2200px;background:rgb(195,195,195);margin-top:10px;margin:0 auto;border-radius:10px">
 
   	<nav class="navbar navbar-default navbar-fixed-top" role="navigation"> 
    <div class="container-fluid"> 
    <div class="navbar-header"> 
        <a class="navbar-brand" href="javascript:searchByRate()">>返回排行榜<</a> 
    </div> 
    <div> 
        <ul class="nav navbar-nav"> 
            <li class="active"><a href="javascript:void(0)" id="accountStatAndOrders">1. 信号统计数据和订单列表</a></li> 
            <li><a href="javascript:void(0)" id="accountProfitAndLoss">2. 信号原始订单收益与风险</a></li>
            <li><a href="javascript:void(0)" id="accountHistoryDrowndown">3. 信号历史回测表现</a></li>   
        </ul> 
    </div> 
    </div> 
</nav>
