  	...
  	<div style="margin-left:0px;margin-right:0px;height:1800px;">
 		...
 		<div style="background:rgb(195,195,195);width:1300px;height:50px;border: 1px solid #C3C3C3;margin: auto;border-radius:5px;text-align:center;">
			<form id="formRate"  action="<c:url value="obtainRankByRate.htm"/>" method="post">
			        <table>
			        	<tr>
			        		<td style="width:180px" align="center">平台名称:</td>			        		
			        		...
			        		<td></td>
			        		<td style="width:180px" align="center">信号名称:</td>
			        		<td style="width:100px" align="center">
 									<input type="text" id="signalName" class="form-control" name="signalName" value=""/>		        		
			        		</td>
			        		<td></td>
			        		<td style="width:50px"></td>
			        		<td align="center"><input type="button" id="searchByCondition" class="btn btn-primary col-lg-3" style="width:80px" value="查询"/></td>
			        	</tr>
			        </table>
			</form>  				
 		</div>
...
<!-- 				                <th style="text-align:center">评分值</th>
		...
		<form id="form1" action="<c:url value="obtainSearchInfoPage.htm"/>" method="post">
		...
		<script type="text/javascript" src="js/jquery.dataTables.min.js"></script> 		
  		<script type="text/javascript">
	  		$(document).ready(function() {
	  		 var broker = '<%=request.getParameter("broker")%>';
	  		 var signalName = '<%=request.getParameter("signalName")%>';
			 ...
			 $('#rankInfo').DataTable( {
			       ...
			       // "serverSide": true,
			        //"ajax": "data/arrays.txt",
  			        "ajax": {			        		        	
 			            "url": "searchInfoResult.htm",
 			            "data":{"broker":broker,"signalName":signalName},
			            "type": "POST", 
