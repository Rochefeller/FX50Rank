		...
		<form id="signup" method="post" action="${ctx}/login/submit" role="form" class="login">
			...
			<div class="form-group">
				<label form="password" class="control-label"> 
					<input id="password" name="password" placeholder="手机号" type="password" class="required" data-i18n="[placeholder]table.password"/>
				</label>
			</div>
			<div class="form-group">
				<label form="password" class="control-label"> 
					<input id="password" name="password" placeholder="邮箱" type="password" class="required" data-i18n="[placeholder]table.password"/>
				</label>
			</div>			
			<div class="form-signup">
				<button id="loginBtn" class="btn btn-block" data-i18n="login.submit">注册</button>
