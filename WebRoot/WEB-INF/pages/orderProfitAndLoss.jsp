 ...
 <!--            <div class="navbar-default sidebar" role="navigation">
		...
		<div style="background:rgb(195,195,195);width:100%;height:1800px;border: 1px solid #C3C3C3;margin:0 auto;border-radius:0px;text-align:center;float:left">
 			<div class="bgimage" style="width:1100px;height:400px;margin:0 auto;margin-top:10px;">
  				<div id="orderNetWorth" style="width:1100px;height:400px;margin:0 auto;margin-top:0px;"></div>
  			</div>
  			<div class="bgimage" style="width:1100px;height:400px;margin:0 auto;margin-top:10px;">
				<div id="orderNetPips" style="width:1100px;height:400px;margin:0 auto;margin-top:0px;"></div>  			
  			</div>
  			 <div class="bgimage" style="width:1100px;height:400px;margin:0 auto;margin-top:10px;">
				<div id="orderProfitDrowdown" style="width:1100px;height:400px;margin:0 auto;margin-top:0px;"></div>  			
  			</div>
  			 <div class="bgimage" style="width:1100px;height:400px;margin:0 auto;margin-top:10px;">
				<div id="orderPipsDrowdown" style="width:1100px;height:400px;margin:0 auto;margin-top:0px;"></div>  			
  			</div>	
		</div>
        <!-- /#page-wrapper -->
        <div>
	...
	<script type="text/javascript">
		...
		//alert(account_id);			  		
 		...
 		psel3.value=planInvest;
	  	//alert(psel1.value);
		window.onload=ProfitAndLossChart(account_id);		
	</script>
</body>
</html>