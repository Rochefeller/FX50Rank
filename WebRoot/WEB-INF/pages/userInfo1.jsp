...
<html>
  ...
  <body>
  	<div style="width:100%;height:2200px;background:rgb(117,172,222)">
  		<div style="width:1200px;height:2200px;background:rgb(117,172,222);margin-top:10px;margin:0 auto;border-radius:10px">
  		
  			<div style="width:100px;height:30px;margin:0 auto;background:rgb(117,172,222);margin-top:10px;margin-left:10px;float:left">
  			...
  			<br>
  			<div style="width:1100px;height:60px;margin:0 auto;background:rgb(117,172,222);margin-top:10px;text-align:center">
  				<table style="width:1095px;height:60px;">
					<tr> 
						<td align="center" style="background:rgb(117,172,222);border:0px solid #00f;width:365px;height:55px">
