    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="tables.html">FX TOP 50</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="main.jsp"><i class="fa fa-table fa-fw"></i>按比例</a>
                        </li>
                        <li>
                            <a href="lots.jsp"><i class="fa fa-edit fa-fw"></i>按固定手数</a>
                        </li>
                        <li>
                            <a href="drowdown.jsp"><i class="fa fa-edit fa-fw"></i>按最大回撤</a>
                        </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-4">
                            <form class="form-horizontal"  id="formLots" action="<c:url value="obtainRankByDrowndown.htm"/>" method="post"> 
                                ...
                                <div class="form-group">
                                    <label class="col-lg-5 control-label">预期最大回撤(USD)</label>
                                    <div class="col-lg-5">
                                        <input type="text" id="groupName" class="form-control" name="name" value="2000"/>
                                    </div>
                                </div>                                  
                                <div class="form-group">
                       ...
                       <div class="col-lg-4 input-group text-center">
                           <button type="button" class="btn btn-primary col-lg-3" id="searchByDrowdown">查询</button>
                       </div>
                    </div>                    
                    <!-- /.panel -->
                </div>
